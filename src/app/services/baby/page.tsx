      ...
      <section className="py-20">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            ...
            {/* 테마 소개 */}
            <div className="mb-20">
              <h3 className="font-serif text-2xl font-medium mb-8 text-center text-primary">촬영 테마 소개</h3>
              <p className="text-center text-foreground/70 mb-12">아래 다양한 테마 중에서 원하시는 컨셉을 선택하여 촬영합니다</p>
              
              {/* 첫돌 기념 테마 */}
              <div className="mb-12">
                <h4 className="font-serif text-xl font-medium mb-6 text-primary">🎂 첫돌 기념 테마</h4>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">돌상 <span className="text-xs text-foreground/60">(변경 가능)</span></h5>
                    <p className="text-sm text-foreground/70">전통적인 돌상과 함께하는 특별한 촬영. 아기의 첫 생일을 잊지 못할 추억으로 남겨보세요.</p>
                  </motion.div>
                  
                  <motion.div 
                    className="bg-white p-4 rounded-xl shadow-sm border-2 border-primary/20"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">돌잡이 <span className="text-xs bg-primary text-white px-2 py-1 rounded">작가 추천</span></h5>
                    <p className="text-sm text-foreground/70">아기의 작은 시선 하나, 움직임 하나가 추억을 만듭니다. 오직 아기만을 위한 베스트 추천 컨셉입니다.</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">한옥 컨셉</h5>
                    <p className="text-sm text-foreground/70">전통의 아름다움과 아기의 순수함이 만드는 특별한 이야기를 기록해보세요.</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">복고 컨셉</h5>
                    <p className="text-sm text-foreground/70">레트로 감성의 배경에서 아기의 순수함을 더욱 빛내보세요.</p>
                  </motion.div>
                </div>
              </div>
              ...
              {/* 백일 기념 테마 */}
              <div className="mb-12">
                <h4 className="font-serif text-xl font-medium mb-6 text-primary">💝 백일 기념 테마</h4>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <motion.div 
                    className="bg-white p-4 rounded-xl shadow-sm"
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">백일상</h5>
                    <p className="text-sm text-foreground/70">백일을 맞이한 아기의 첫 발걸음. 소중한 추억을 담아보세요.</p>
                  </motion.div>
                  
                  <motion.div 
                    className="bg-white p-4 rounded-xl shadow-sm border-2 border-accent/20"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.5, delay: 0.1 }}
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">전통 누드 <span className="text-xs bg-accent text-white px-2 py-1 rounded">백일 한정</span></h5>
                    <p className="text-sm text-foreground/70">누드 촬영은 백일에만 찍을 수 있는 시그니처 컨셉입니다. (돌끝맘들이 안찍고 정말 후회하는 컨셉 ㅜㅜ)</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">스튜디오 컨셉</h5>
                    <p className="text-sm text-foreground/70">아기의 컨디션에 따라 스튜디오가 보유한 다양한 컨셉 장소에서 자연스럽게 연출하여 촬영합니다.</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">가족 <span className="text-xs bg-primary text-white px-2 py-1 rounded">추천</span></h5>
                    <p className="text-sm text-foreground/70">우리 가족의 젊은 날, 소중한 이야기를 담은 특별한 순간을 기록해보세요.</p>
                  </motion.div>
                </div>
              </div>
              ...
              {/* 추가 컨셉 */}
              <div>
                <h4 className="font-serif text-xl font-medium mb-6 text-primary">✨ 추가 선택 컨셉</h4>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <motion.div 
                    className="bg-white p-4 rounded-xl shadow-sm"
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">형제/자매</h5>
                    <p className="text-sm text-foreground/70">형제나 자매가 있다면 꼭 추천드려요. 귀여운 의상의 투샷. 너무나 소중한 것.</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">스튜디오 컨셉</h5>
                    <p className="text-sm text-foreground/70">자연의 빛 속에서, 햇살 가득한 순간 아기의 사랑스러운 미소를 기록하세요.</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">레몬 컨셉</h5>
                    <p className="text-sm text-foreground/70">레몬의 상큼함이 가득한 이 순간, 아기의 순수함이 더욱 빛나게 담겨집니다.</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <h5 className="font-medium text-primary mb-2">가족 <span className="text-xs bg-accent text-white px-2 py-1 rounded">가심비 추천</span></h5>
                    <p className="text-sm text-foreground/70">캐주얼한 의상과 깔끔한 배경으로 가족의 자연스러운 모습을 담아냅니다.</p>
                  </motion.div>
                </div>
              </div>
            </div>
